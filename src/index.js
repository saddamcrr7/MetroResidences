...
const heroLoad = () => {
  ...
  TweenMax.to(".o-hero__banner", 1, {top: '-900px',left: '-2600px', transform: `scale(1.4)`, ease: "power2.out",})
}
...
.to(".o-hero__banner", 1, {top: '-400px',left: '-1600px'}, '-=1')

const tl1 = new TimelineMax();
tl1.to(".o-hero__title", 1, {top: "-100%", })
.to(".o-hero__sub", 1, {top: '50%', },'-=1')
.to(".o-hero__banner", 1, {top: '-1500px',left: '-1600px'}, '-=1')
